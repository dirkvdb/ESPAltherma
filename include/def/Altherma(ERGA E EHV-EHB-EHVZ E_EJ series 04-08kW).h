...
{0x20,0,105,2,1,"outdoor_temperature"},
...
{0x21,0,105,2,-1,"inv_primary_current"},
{0x21,2,105,2,-1,"inv_secondary_current"},
{0x21,4,101,2,-1,"voltage_n_phase"},
...
{0x60,2,315,1,-1,"iu_operation_mode"},
{0x60,2,303,1,-1,"thermostat"},
{0x60,2,302,1,-1,"freeze_protection"},
...
{0x60,11,303,1,-1,"solar_input"},
{0x60,11,302,1,-1,"smartgrid_contact_2"},
{0x60,11,301,1,-1,"smartgrid_contact_1"},
//{0x60,11,300,1,-1,"Bivalent Operation"},
//{0x60,12,307,1,-1,"2way valve(On:Heat_Off:Cool)"},
//{0x60,12,306,1,-1,"3way valve(On:DHW_Off:Space)"},
{0x60,12,305,1,-1,"bsh"},
{0x60,12,304,1,-1,"buh_step1"},
{0x60,12,303,1,-1,"buh_step2"},
...
{0x61,2,105,2,1,"leaving_water_temperature_before_buh"},
{0x61,4,105,2,1,"leaving_water_temperature_after_buh"},
//{0x61,6,105,2,1,"Refrig. Temp. liquid side (R3T)"},
{0x61,8,105,2,1,"inlet_water_temperature"},
{0x61,10,105,2,1,"dhw_temperature"},
{0x61,12,105,2,1,"indoor_temperature"},
